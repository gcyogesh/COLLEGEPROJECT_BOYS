                                ...
                                <form action="" >
                                    <div className='row flex flex-col gap-4'>
                                        <div className="row flex flex-col md:flex-row gap-4 md:gap-8">
                                            <input type="text" name="name" id="nameInput" placeholder='Your Name' className='md:w-1/2 outline-blue-200 bg-red-50 py-4 px-8 rounded-md' />
                                            <input type="email" name="email" id="emailInput" placeholder='Your Email' className='md:w-1/2 outline-blue-200 bg-red-50 py-4 px-8 rounded-md' />
                                        </div>
                                        <div className="row">
                                            <input type="text" name="subject" id="subjectInput" placeholder='Subject' className='w-full outline-blue-200 bg-red-50 py-4 px-8 rounded-md' />
                                        </div>
                                        <div className="row">
                                            <textarea name="message" id="messageInput" rows={8} placeholder='How can we help?' className='w-full max-h-[20rem] outline-blue-200 bg-red-50 py-4 px-8 rounded-md' ></textarea>
                                        </div>
                                        <div className="row">
